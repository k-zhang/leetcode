...
import com.algomind.leetcode.easy.KthLargestElementInASteam;
...
class KthLargestElementInASteamTest {
    @ParameterizedTest
    @MethodSource("provideData")
    public void test(int[] expected, int k, int[] init, int[] nums) {
        KthLargestElementInASteam solution = new KthLargestElementInASteam(k, init);
